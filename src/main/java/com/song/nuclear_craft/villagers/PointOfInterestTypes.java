...
public class PointOfInterestTypes {
    ...
    public static final RegistryObject<PointOfInterestType> RIFLE_AMMO_SELLER = POINT_OF_INTEREST_TYPE.register(("rifle_ammo_seller"),
            ()-> new PointOfInterestType(Util.getResourceString("rifle_ammo_seller"), PointOfInterestType.getAllStates(BlockList.STATUE_OF_RIFLE_AMMO.get()), 1, 1));
    public static final RegistryObject<PointOfInterestType> SHOTGUN_AMMO_SELLER = POINT_OF_INTEREST_TYPE.register(("shotgun_ammo_seller"),
            ()-> new PointOfInterestType(Util.getResourceString("shotgun_ammo_seller"), PointOfInterestType.getAllStates(BlockList.STATUE_OF_SHOTGUN_AMMO.get()), 1, 1));
    public static final RegistryObject<PointOfInterestType> GUN_SELLER = POINT_OF_INTEREST_TYPE.register(("gun_seller"),
            ()-> new PointOfInterestType(Util.getResourceString("gun_seller"), PointOfInterestType.getAllStates(BlockList.STATUE_OF_LIBERTY.get()), 1, 1));
    public static final RegistryObject<PointOfInterestType> ROCKET_MASTER = POINT_OF_INTEREST_TYPE.register(("rocket_master"),
            ()-> new PointOfInterestType(Util.getResourceString("rocket_master"), PointOfInterestType.getAllStates(BlockList.STATUE_OF_ROCKET.get()), 1, 1));
    public static final RegistryObject<PointOfInterestType> EXPLOSIVE_MASTER = POINT_OF_INTEREST_TYPE.register(("explosive_master"),
            ()-> new PointOfInterestType(Util.getResourceString("explosive_master"), PointOfInterestType.getAllStates(BlockList.STATUE_OF_EXPLOSIVE.get()), 1, 1));
}
