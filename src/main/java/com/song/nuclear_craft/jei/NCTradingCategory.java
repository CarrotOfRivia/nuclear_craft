...
//
//    @Override
//    public void draw(NCTradingRecipe recipe, PoseStack matrixStack, double mouseX, double mouseY) {
//        IRecipeCategory.super.draw(recipe, matrixStack, mouseX, mouseY);
//        Minecraft minecraft = Minecraft.getInstance();
//        minecraft.font.draw(matrixStack, recipe.price1Min.get()+"-"+recipe.price1Max.get(), 0, 22, 0x5161f);
//        if(recipe.getItem2() != null){
//            minecraft.font.draw(matrixStack, recipe.price2Min.get()+"-"+recipe.price2Max.get(), 49, 22, 0x5161f);
//        }
//        minecraft.font.draw(matrixStack, recipe.outputMin.get()+"-"+recipe.outputMax.get(), 107, 22, 0x5161f);
//    }
//}
